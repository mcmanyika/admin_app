...
<div data-role="page" id="page1">
  ...
  <div class="col-xs-12">
  <h1><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add Member</button></h1>
<input type="text" class="form-control input-lg" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name">
    ...
    <table id="myTable" width="100%">
      ...
      <?php do { ?>
      <tr>
        <td><a href="pay.php?recordID=<?php echo $row_usr['id']; ?>"><?php echo $row_usr['fname']; ?> <?php echo $row_usr['lname']; ?></a></td>
...
Records <?php echo ($startRow_usr + 1) ?> to <?php echo min($startRow_usr + $maxRows_usr, $totalRows_usr) ?> of <?php echo $totalRows_usr ?> <!-- Modal -->
