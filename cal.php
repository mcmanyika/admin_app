...
mysql_select_db($database_connection, $connection);
$query_rcpt = sprintf("SELECT * FROM t_finance WHERE root_id = %s AND flag = 8 ORDER BY id DESC", GetSQLValueString($colname_rcpt, "int"));
...
<div data-role="page" id="page1">
  <div data-role="header">
    <h1><a href="index.php" data-role="button" data-transition="flip"  data-inline="true" data-icon="bars" style="text-transform:capitalize">HIM Finance Dashboard</a></h1>
  </div>
...
<div class="col-md-12">
  <div class="col-md-7">
      <form method="post" id="form2" name="form2" action="<?php echo $editFormAction; ?>">
        ...
        <button type="submit" data-inline="true" data-icon="bars">Make Payment</button>
      ...
      <form method="POST" name="form1" action="<?php echo $editFormAction; ?>">
        ...
        <div class="col-md-8">
		<?php do { ?>
          <div class="col-md-4" style="height:70px"><input type="radio" name="pay_option" value="<?php echo $row_pay_op['name']; ?>"<?php echo $row_pay_op['status']; ?>><br /> <?php echo $row_pay_op['name']; ?>
            </div>
          <?php } while ($row_pay_op = mysql_fetch_assoc($pay_op)); ?>
          </div>
        <div class="col-md-4">
          	<input type="text" class="form-control input-lg" name="amount" value="" size="32" placeholder="0">
    ...
    <div class="col-md-5">
        ...
        <input type="button" value="C" onClick="btnclear()" class="cal" style="width:170px;"/>
      
      <script>
	  	function btnclear() {
			document.form1.amount.value ="";
			document.form1.amount.style.textAlign="right";
			}
	  </script>
